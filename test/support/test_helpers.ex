defmodule SearchableSelect.TestHelpers do
  @moduledoc false

  use SearchableSelectWeb.ConnCase, async: true
  ...
  @selectors [
    container: "div[phx-hook=SearchableSelect]",
    clear_button: "button[phx-click=clear]",
    clear_tag_button: "div[phx-hook=SearchableSelect] > div:first-child > div > button",
    dropdown: "div[phx-hook=SearchableSelect] > ul",
    dropdown_entries: "div[phx-hook=SearchableSelect] > ul > li > div",
    hidden_input: "input#my_form_city_search",
    option: "div[phx-hook=SearchableSelect] > ul > li > div",
    tags_container: "div[phx-hook=SearchableSelect] > div:first-child",
    tag: "div[phx-hook=SearchableSelect] > div:first-child > div",
  ...
  def stub_options(options, opts \\ []) do
    Mox.stub(SearchableSelect.ChangeEventHandlerMock, :handle, fn params, _ ->
